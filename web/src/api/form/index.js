...
//根据id获取表单列表
const getFormList = (params) => postAction(`/uc/api/form/listByCollection/${params.id}`, params.pageBean)
//根据id获取表单大类
...
export { addFormCollection, updateFormCollection, delFormCollection, getFormList, getFormCategories, updateFormCategory, addFormCategory, delFormCategory, addForm, delForm }