  ...
  <div>
    ...
    >
      ...
      <template slot="action" slot-scope="scope">
        <a @click="handleConfig(scope.row)" v-has="'taskDetail_config'" v-if="scope.row.status == -1">配置人员</a>
        <el-divider direction="vertical" v-if="judgeApply(scope.row, currentUser)" />
    ...
    <config-user-dialog ref="configUserDialog" @refresh="loadData" />
...
import { judgeShow, judgeApply, judgeAudit, judgeProgress, judgeRedo, judgeRemind } from './auth'
