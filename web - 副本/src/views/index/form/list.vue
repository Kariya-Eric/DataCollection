<template>
  <div>
    <el-card shadow="always" class="app-card">
      ...
      >
        ...
        <template slot="enabled" slot-scope="scope">
          <el-switch :active-value="1" :inactive-value="0" v-model="scope.row.enabledFlag" @change="val => enableForm(val, scope.row)"></el-switch>
        </template>
    ...
    <add-collection-dialog ref="modalForm" @refresh="loadData" name="合集" />
...
import GuideFilesDialog from './components/collections/guide-files-dialog.vue'
