    ...
    >
      ...
      <template slot="action" slot-scope="record">
        <span class="action-span">
          ...
          <a v-if="judgeProgress(record, currentUser, roleList)">协作进度</a>
        </span>
      </template>
    </a-table>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { dataIndex: 'collaborateOrgName', title: '填报部门', align: 'center', ellipsis: true },
        { dataIndex: 'fillUserName', title: '填报人', align: 'center', ellipsis: true },
