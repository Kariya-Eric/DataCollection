<template>
  ...
  >
    ...
    <template v-for="option of selectOptions">
      <a-select-option :value="option.value" :disabled="option.disabled" :key="option.value">
...
export default {
  ...
  created() {
    let multiple = [DCVXETypes.selectMultiple, DCVXETypes.list_multi]
    let search = [DCVXETypes.selectSearch, DCVXETypes.sel_search]
