...
import './styles/dc-vxe-table.less'
// 引入 vxe-table
import 'xe-utils'
...
Vue.component(DCVxeTable.name, DCVxeTable)
 ...
 * @param type 类型
 * @param cell 输入组件
 * @param span 显示组件，可空，默认为 DCVxeNormalCell 组件
 */
...
export function installCell(type, cell, span) {
  let exclude = [DCVXETypes.rowNumber, DCVXETypes.rowCheckbox, DCVXETypes.rowDragSort]
